...
Currently working with StencilJS, Ionic and .NET Core at Arvato. One of my favorite things to do on my free time (besides playing the guitar) is to build new architectures in order to challenge myself with new development patterns. Also one of my hobbies include learning new stacks, for instance, right now I'm quite interested in Golang.
